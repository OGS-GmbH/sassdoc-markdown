...
export default defineConfig({
  title: "sassdoc-markdown",
  description: "Convert your SassDoc documentation to Markdown",
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: packageJson.version, items: [
        { text: "Repository", link: "https://github.com/OGS-GmbH/sassdoc-markdown" },
        { text: "Changelog", link: "https://github.com/OGS-GmbH/sassdoc-markdown/blob/main/CHANGELOG.md" },
    ...
    sidebar: [
      {
        ...
        items: [
          ...
          { text: "Programatically", link: "/guide/programatically" }
        ]
      },
      sidebarPlugin({
  ...
  base: "/sassdoc-markdown/",
  srcDir: "../dist/vitepress-src",
  outDir: "../dist/docs",
  titleTemplate: ":title - OGS sassdoc-markdown",
  cleanUrls: true,
  appearance: true,
  markdown: {
